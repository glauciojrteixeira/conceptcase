...
import br.com.cenarioesolucao.conceptcase.services.ClienteService;
...
public class ClienteResource {
	...
	public ResponseEntity<Cliente> buscarEmail(@RequestParam(value = "value") String email) {
		
		Cliente body = service.buscarEmail(email);
